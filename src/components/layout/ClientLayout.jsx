...
function ClientLayout({ children }) {
  ...
  return (
    <div className="min-h-screen bg-brand-dark text-slate-100 font-sans flex">
      {/* SIDEBAR */}
      <aside className="w-64 bg-[#0b0f17] border-r border-slate-800/80 flex flex-col justify-between shrink-0">
        <div>
      ...
      <div className="flex-1 flex flex-col min-w-0">
        <header className="h-16 bg-[#0b0f17]/90 border-b border-slate-800/80 px-6 flex items-center justify-between gap-4 shrink-0 backdrop-blur-md">
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="flex items-center gap-2.5 pl-2 border-l border-slate-800">
              <div className="w-8 h-8 rounded-lg bg-gradient-to-tr from-amber-500 to-amber-300 flex items-center justify-center font-bold text-black text-xs">
